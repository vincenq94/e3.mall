...
<table class="easyui-datagrid" id="itemList" title="商品列表" 
       data-options="singleSelect:false,collapsible:true,pagination:true,url:'${pageContext.request.contextPath}/itemController/getItemListPage',method:'get',pageSize:30,toolbar:toolbar">
    <thead>
        <tr>
